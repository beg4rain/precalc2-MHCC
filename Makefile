...
html:
	...
	cd $(HTMLOUT); \
	xsltproc -xinclude --stringparam webwork.server $(SERVER) --stringparam html.knowl.example no --stringparam html.knowl.exercise.inline no $(MBXSL)/mathbook-html.xsl $(PRJSRC)/precalc2-MHCC.xml
